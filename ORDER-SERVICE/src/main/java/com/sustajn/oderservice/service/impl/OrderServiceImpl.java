...
//                    .collect(Collectors.toMap(BorrowOrder::getId, borrowOrder -> borrowOrder));
//
...
//
//            // Fetch product names from Inventory Service
//            Map<Long, String> productNameMap = inventoryFeignClient.getProductsByIds(new ArrayList<>(productIds))
//                    .stream()
//                    .collect(Collectors.toMap(
//                            p -> p.getProductId().longValue(),
...
//
//                leasedResponses.add(new LeasedResponse(products, orderId, dateTime, totalQty));
//            }
//
//            // ================= RECEIVED =================
//
...
//
//                receivedResponses.add(new ReceivedResponse(products, orderId, dateTime, totalReturnedQty));
//            }
//
//            // ================= FINAL RESPONSE =================
//
//            OrderHistoryResponse response = new OrderHistoryResponse(leasedResponses, receivedResponses);
//
